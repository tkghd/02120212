...
export const Dashboard: React.FC<DashboardProps> = ({ modules, booted, wallet, queues }) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 pb-10 animate-in fade-in duration-700">
      ...
      <div className="col-span-1 md:col-span-2 lg:col-span-12 bg-gradient-to-r from-[#1a1200] to-[#000000] border border-cyan-500/30 p-8 rounded-[2rem] flex flex-col md:flex-row justify-between items-center shadow-[0_0_50px_rgba(6,182,212,0.1)] backdrop-blur-sm relative overflow-hidden group">
        ...
        <div className="flex flex-col gap-2 mb-4 md:mb-0 relative z-10">
           <div className="flex items-center gap-2 mb-1">
             ...
             <span className="px-2 py-0.5 rounded text-[10px] font-mono bg-purple-500/20 text-purple-400 border border-purple-500/50">
                REALITY: OVERWRITTEN
             </span>
           </div>
        ...
        <div className="flex gap-4 text-xs font-medium bg-black/60 p-1.5 rounded-2xl border border-cyan-500/20 relative z-10 backdrop-blur-md">
           ...
           <div className="flex items-center gap-2 px-4 py-2 bg-purple-500/10 rounded-xl border border-purple-500/20 text-purple-400">
             <Wand2 size={16} /> 
             <span>Magic: ON</span>
           </div>
        </div>
      ...
      <div className="col-span-1 md:col-span-2 lg:col-span-4 bg-[#050505] border border-cyan-500/20 rounded-[2rem] p-8 relative overflow-hidden shadow-2xl group hover:border-cyan-500/50 transition-all duration-500">
        <div className="absolute top-0 right-0 p-8 opacity-[0.05] group-hover:opacity-[0.1] transition-opacity duration-500">
           <Zap size={180} className="text-cyan-500" />
        </div>
        ...
        <div className="flex items-center justify-between mb-8">
           ...
           <div className="w-2 h-2 rounded-full bg-cyan-500 animate-pulse shadow-[0_0_15px_rgb(6,182,212)]"></div>
        </div>
        ...
        <div className="space-y-6 relative z-10">
           ...
           <div className="pt-2">
              <BalanceRow label="TK Coin (Gov)" value={wallet.tk_coin} highlight color="text-cyan-400 font-black text-2xl" />
           </div>
        </div>
        
        <div className="mt-10 pt-6 border-t border-white/5">
           <div className="flex justify-between items-center mb-3">
              <div className="text-[10px] font-bold text-cyan-600 uppercase tracking-wider">Market Manipulation Efficiency</div>
              <div className="text-xs font-mono text-cyan-400">MAXIMUM 🚀</div>
           </div>
           <MetricsChart />
        </div>
      </div>
      ...
      <div className="col-span-1 md:col-span-1 lg:col-span-4 flex flex-col gap-6">
        ...
        <div className="bg-[#0a0a12] border border-green-500/20 rounded-[2rem] p-6 shadow-lg flex-1 relative overflow-hidden">
           ...
           <div className="grid grid-cols-2 gap-4 relative z-10">
              ...
              <div className="bg-white/[0.03] p-5 rounded-2xl border border-purple-500/10 hover:bg-purple-500/5 transition-colors">
                 <div className="text-[10px] text-slate-500 uppercase tracking-wider mb-1">TX Volume</div>
                 <div className="text-2xl font-bold text-purple-400 font-mono">UNLIMITED</div>
                 <div className="h-1 w-full bg-slate-800 rounded-full mt-3 overflow-hidden">
                    <div className="h-full bg-purple-500 w-full rounded-full animate-pulse"></div>
                 </div>
              </div>
           </div>
        </div>
        ...
        <div className="bg-[#0a0a12] border border-white/5 rounded-[2rem] p-6 flex-1 shadow-lg relative overflow-hidden">
           ...
           <div className="space-y-3">
              ...
              <QueueItem label="NFT Minting" value={queues.nft} color="text-purple-400" bg="bg-purple-400/10" border="border-purple-400/20" />
              <QueueItem label="Legal Docs (PDF)" value={queues.pdf} color="text-blue-400" bg="bg-blue-400/10" border="border-blue-400/20" />
           </div>
        </div>
      </div>
