...
app.listen(PORT, () => {
  console.log('\n╔═══════════════════════════════════════════════════════════╗');
  console.log('║   🏦 TK Global Bank - 統合API (全銀対応)              ║');
  console.log('╚═══════════════════════════════════════════════════════════╝\n');
  console.log(`⚡ Port: ${PORT}`);
  console.log(`🏦 全銀対応: ${Object.keys(ZENGIN_BANKS).length}行`);
  console.log(`🌐 CORS: 有効`);
  console.log(`📡 エンドポイント:`);
  console.log(`   /api/zengin/banks - 銀行リスト`);
  console.log(`   /api/zengin/transfer - 送金実行`);
  console.log(`   /api/zengin/verify-account - 口座確認\n`);
});
